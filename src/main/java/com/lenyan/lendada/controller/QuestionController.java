...
import com.lenyan.lendada.model.enums.AppTypeEnum;
...
public class QuestionController {
    ...
    private static final String GENERATE_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家，我会给你如下信息：\n" +
            ...
            "```\n" +
            "title 是题目，options 是选项，每个选项的 key 按照英文字母序（比如 A、B、C、D）以此类推，value 是选项内容，score是得分（如果是得分类应用：appType = 0，正确的选项选项得分为1，并且正确的选项随机放置在选项中。如果是测评类应用忽略score）\n" +
