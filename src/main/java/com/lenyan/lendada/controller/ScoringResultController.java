...
import com.lenyan.lendada.model.dto.scoringResult.ScoringResultAddRequest;
import com.lenyan.lendada.model.dto.scoringResult.ScoringResultEditRequest;
import com.lenyan.lendada.model.dto.scoringResult.ScoringResultQueryRequest;
import com.lenyan.lendada.model.dto.scoringResult.ScoringResultUpdateRequest;
...
public class ScoringResultController {
    ...
    public BaseResponse<Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest, HttpServletRequest request) {
        ...
        // 填充默认图片地址
        scoringResult.setResultPicture("https://tse1.mm.bing.net/th/id/OIP.cpF-1DqgvbkZ5xJneJrNewHaFO?rs=1&pid=ImgDetMain&o=7&rm=3");
        // 写入数据库
